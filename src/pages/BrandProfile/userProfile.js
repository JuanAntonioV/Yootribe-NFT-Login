      ...
      <form onSubmit={handleSubmit} className="form" style={{ width: '100%', padding: '50px 80px' }}>
        <div className="form-group">
          <label style={{ color: 'white' }} htmlFor="message">
            Please describe the fields you need to change
          </label>
          <textarea id="message" name="message" required style={{ width: '100%' }} />
        </div>
              ...
              <div className="formik-form">
                <div>
                  <p>
                    ...
                    <span style={{ cursor: 'pointer' }} onClick={showPopup}>
                      {' '}
                      please click here
                    </span>
                    .
                ...
                {formResult === 'OK' && (
                  <div className="col-12 errors bg-success text-white">Email was successfully sent to the admin.</div>
                )}
                {formResult === 'KO' && <div className="col-12 errors">{formError}</div>}
                ...
                <div className={'inputs-two-cells'}>
                  <div className={'input-wrapper'}>
                    ...
                    <IntlTelInputByIp style={{ paddingRight: 0 }} value={user?.phone} disabled />
                  </div>
                  <div className={'input-wrapper'}>
